<template>
  <div>
    <div class="container">
      <h1><a href="https://chrome.google.com/webstore/detail/mkcjnnikmjpffddmjgmphcijkbdlnhfd">mnml new tab</a></h1>
      <p><a href="https://chrome.google.com/webstore/detail/mkcjnnikmjpffddmjgmphcijkbdlnhfd">install</a></p>
      <h3>
        a chrome extension for listing todos, checking them off, and clearing them
      </h3>
      <img src='../assets/add-todos.gif' />
      <h3>
        includes a spot for rich text notes and a column for a daily calendar view (if you opt in with gcal)
      </h3>
      <img src='../assets/add-notes.gif' />
    </div>
    <div class="privacy" id="privacy">
      ...
      <ul>
        ...
        <li>
          <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to mnml new tab.</p>
        </li>
        <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
        <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
        <li><strong>Website</strong> refers to mnml new tab, accessible from <a href="https://robonyong.github.io/mnml-new-tab">https://robonyong.github.io/mnml-new-tab</a></li>
      ...
      <ul>
        <li>By visiting this page on our website: <a href="https://github.com/robonyong/mnml-new-tab/issues">https://github.com/robonyong/mnml-new-tab/issues</a></li>
      </ul>
    </div>
  </div>
</template>
